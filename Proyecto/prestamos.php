...
if (isset($_GET['busqueda'])) {
    ...
    // Consulta SQL para obtener los préstamos que coinciden con la búsqueda
    $sql = "SELECT fk_empleado_id, monto_prestamo, plazo_meses, saldo_pendiente FROM Prestamos WHERE fk_empleado_id LIKE '%$busqueda%'";
} else {
    // Consulta SQL para obtener todos los préstamos
    $sql = "SELECT fk_empleado_id, monto_prestamo, plazo_meses, saldo_pendiente FROM Prestamos";
}
...
<div class="container">
    ...
    <form class="form-inline mb-3">
        <input type="text" class="form-control mr-2" placeholder="Buscar por empleado ID" name="busqueda"
               value="<?php echo $busqueda; ?>">
        <button class="btn btn-primary">Buscar</button>
            <a href="agregarprestamos.php" class="btn btn-success margin-left">Agregar prestamo</a>
