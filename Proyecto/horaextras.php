...
if (isset($_GET['busqueda'])) {
    ...
    // Consulta SQL para obtener las horas extras que coinciden con la búsqueda
    $sql = "SELECT horas_id, fk_empleado_id, fecha, horas_trabajadas FROM HorasExtras WHERE fk_empleado_id LIKE '%$busqueda%' OR fecha LIKE '%$busqueda%' OR horas_trabajadas LIKE '%$busqueda%'";
} else {
    // Consulta SQL para obtener todas las horas extras
    $sql = "SELECT horas_id, fk_empleado_id, fecha, horas_trabajadas FROM HorasExtras";
}
...
<div class="container">
    ...
    <form class="form-inline mb-3">
        <input type="text" class="form-control mr-2"
            placeholder="Buscar por Código Empleado, Fecha o Horas Trabajadas" name="busqueda"
            value="<?php echo $busqueda; ?>">
        <button class="btn btn-primary">Buscar</button>
        <a href="agregarhoraextras.php" class="btn btn-success margin-left">Agregar Horas Extras</a>
    </form>
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='3'>No se encontraron horas extras.</td></tr>";
            }
            ?>
        </tbody>
    </table>
