...
if (isset($_GET['busqueda'])) {
    ...
    $sql = "SELECT ausencia_id, fk_empleado_id, motivo, fecha_inicio, fecha_fin, autorizada FROM Ausencias WHERE fk_empleado_id LIKE '%$busqueda%' OR autorizada LIKE '%$busqueda%'";

} else {
    // Consulta SQL para obtener todos los empleados
    $sql = "SELECT ausencia_id, fk_empleado_id, motivo, fecha_inicio, fecha_fin, autorizada FROM Ausencias";
}
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-inline mb-3">
            ...
            <a href="agregar_ausencia.php" class="btn btn-success margin-left">Agregar ausencia</a>
