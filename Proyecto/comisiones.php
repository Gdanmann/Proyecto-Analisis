...
if (isset($_GET['busqueda'])) {
    ...
    $sql = "SELECT comision_id, fk_empleado_id, ventas, comision FROM ComisionesVentas WHERE fk_empleado_id LIKE '%$busqueda%'";

} else {
    // Consulta SQL para obtener todos los empleados
    $sql = "SELECT comision_id, fk_empleado_id, ventas, comision FROM ComisionesVentas";
}
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-inline mb-3">
            ...
            <a href="agregarcomisiones.php" class="btn btn-success margin-left">Agregar comisión</a>
