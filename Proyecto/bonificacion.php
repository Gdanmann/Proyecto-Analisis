...
if (isset($_GET['busqueda'])) {
    ...
    $sql = "SELECT bonificacion_id, fk_empleado_id, piezas_elaboradas, bonificacion FROM BonificacionesProduccion WHERE fk_empleado_id LIKE '%$busqueda%'";

} else {
    // Consulta SQL para obtener todos los empleados
    $sql = "SELECT bonificacion_id, fk_empleado_id, piezas_elaboradas, bonificacion FROM BonificacionesProduccion";
}
 ...
 <form action="index.php" method="POST">
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Historial Aumentos</a></li>
                            <li><a class="dropdown-item" href="#">Horas extras</a></li>
                            <li><a class="dropdown-item" href="#">Prestamos</a></li>
                            <li><a class="dropdown-item" href="#">Poliza contable</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Compra solidarista</a></li>
                            <li><a class="dropdown-item" href="#">Comisiones ventas</a></li>
                            <li><a class="dropdown-item" href="#">Compra solidarista</a></li>
                            <li><a class="dropdown-item" href="#">Bonificacion produccion</a></li>
                        </ul>
                    </li>
    ...
    <div class="container">
        ...
        <form class="form-inline mb-3">
            ...
            <a href="agregarbonificacion.php" class="btn btn-success margin-left">Agregar Bonificacion</a>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . $row["bonificacion_id"] . "</td>";
                        echo "<td>" . $row["fk_empleado_id"] . "</td>";
                        echo "<td>" . $row["piezas_elaboradas"] . "</td>";
